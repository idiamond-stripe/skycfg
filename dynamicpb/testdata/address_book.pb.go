...
type Person_PhoneNumber struct {
	...
	Type   Person_PhoneType `protobuf:"varint,2,opt,name=type,proto3,enum=testdata.Person_PhoneType" json:"type,omitempty"`
}
...
var file_address_book_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x74, 0x65, 0x73, 0x74, 0x64, 0x61, 0x74, 0x61, 0x22, 0xfc,
	...
	0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x50,
	0x65, 0x72, 0x73, 0x6f, 0x6e, 0x2e, 0x50, 0x68, 0x6f, 0x6e, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65,
	0x72, 0x52, 0x06, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x73, 0x1a, 0x55, 0x0a, 0x0b, 0x50, 0x68, 0x6f,
	...
	0x65, 0x73, 0x74, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x52, 0x06,
...
var file_address_book_proto_goTypes = []interface{}{
	(Person_PhoneType)(0),      // 0: testdata.Person.PhoneType
	(*Person)(nil),             // 1: testdata.Person
	(*AddressBook)(nil),        // 2: testdata.AddressBook
	(*Person_PhoneNumber)(nil), // 3: testdata.Person.PhoneNumber
}
var file_address_book_proto_depIdxs = []int32{
	3, // 0: testdata.Person.phones:type_name -> testdata.Person.PhoneNumber
	1, // 1: testdata.AddressBook.people:type_name -> testdata.Person
	0, // 2: testdata.Person.PhoneNumber.type:type_name -> testdata.Person.PhoneType
